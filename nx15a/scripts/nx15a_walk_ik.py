...
mlist0_h = [round(-(FtCoLF0[0]+Xp),1), round(FtCoLF0[1],1), round(FtCoLF0[2]-Zc,1), \
    round(-(FtCoLR0[0]-Xp),1), round(FtCoLR0[1],1), round(FtCoLR0[2]-Zc,1), \
    round(-(FtCoRF0[0]+Xp),1), round(FtCoRF0[1],1), round(-(FtCoRF0[2]+Zc),1), \
    round(-(FtCoRR0[0]-Xp),1), round(FtCoRR0[1],1), round(-(FtCoRR0[2]+Zc),1)]

def on_press(key):
    global angXX, angYY, angZZ, shiftXX, shiftYY, shiftZZ, flag_w_s
    keyinput = key.char
    if keyinput == "y":
        flag_w_s = 0
    if keyinput == "h":
...
def talker(shiftX, shiftY, shiftZ, angX, angY, angZ):
    ...
    mlist0 = [round(-(FtCoLF0[0]+Xp),1), round(FtCoLF0[1],1), round(FtCoLF0[2]-Zc,1), \
    round(-(FtCoLR0[0]-Xp),1), round(FtCoLR0[1],1), round(FtCoLR0[2]-Zc,1), \
    round(-(FtCoRF0[0]+Xp),1), round(FtCoRF0[1],1), round(-(FtCoRF0[2]+Zc),1), \
    round(-(FtCoRR0[0]-Xp),1), round(FtCoRR0[1],1), round(-(FtCoRR0[2]+Zc),1)]

    mlist1 = [round(-(FtCoLF0[0]+Xp),1), round(FtCoLF0[1],1), round(FtCoLF0[2]-Zc,1), \
    round(-(FtCoLR0[0]-Xp),1), round(FtCoLR0[1],1) - fup, round(FtCoLR0[2]-Zc,1), \
    round(-(FtCoRF0[0]+Xp),1), round(FtCoRF0[1],1) - fup, round(-(FtCoRF0[2]+Zc),1), \
    round(-(FtCoRR0[0]-Xp),1), round(FtCoRR0[1],1), round(-(FtCoRR0[2]+Zc),1)]

    mlist2 = [round(-(FtCoLFtf1[0]+Xp),1), round(FtCoLRtf1[1],1), round(FtCoLFtf1[2]-Zc,1), \
    round(-(FtCoLRtf0[0]-Xp),1), round(FtCoLRtf0[1],1), round(FtCoLRtf0[2]-Zc,1), \
    round(-(FtCoRFtf0[0]+Xp),1), round(FtCoRFtf0[1],1), round(-(FtCoRFtf0[2]+Zc),1), \
    round(-(FtCoRRtf1[0]-Xp),1), round(FtCoRRtf1[1],1), round(-(FtCoRRtf1[2]+Zc),1)]

    mlist3 = [round(-(FtCoLFtf2[0]+Xp),1), round(FtCoLRtf2[1],1), round(FtCoLFtf2[2]-Zc,1), \
    round(-(FtCoLR0[0]-Xp),1), round(FtCoLR0[1],1), round(FtCoLR0[2]-Zc,1), \
    round(-(FtCoRF0[0]+Xp),1), round(FtCoRF0[1],1), round(-(FtCoRF0[2]+Zc),1), \
    round(-(FtCoRRtf2[0]-Xp),1), round(FtCoRRtf2[1],1), round(-(FtCoRRtf2[2]+Zc),1)]
    
    mlist4 = [round(-(FtCoLF0[0]+Xp),1), round(FtCoLF0[1],1) - fup, round(FtCoLF0[2]-Zc,1), \
    round(-(FtCoLR0[0]-Xp),1), round(FtCoLR0[1],1), round(FtCoLR0[2]-Zc,1), \
    round(-(FtCoRF0[0]+Xp),1), round(FtCoRF0[1],1), round(-(FtCoRF0[2]+Zc),1), \
    round(-(FtCoRR0[0]-Xp),1), round(FtCoRR0[1],1) - fup, round(-(FtCoRR0[2]+Zc),1)]

    mlist5 = [round(-(FtCoLFtf0[0]+Xp),1), round(FtCoLRtf0[1],1), round(FtCoLFtf0[2]-Zc,1), \
    round(-(FtCoLRtf1[0]-Xp),1), round(FtCoLRtf1[1],1), round(FtCoLRtf1[2]-Zc,1), \
    round(-(FtCoRFtf1[0]+Xp),1), round(FtCoRFtf1[1],1), round(-(FtCoRFtf1[2]+Zc),1), \
    round(-(FtCoRRtf0[0]-Xp),1), round(FtCoRRtf0[1],1), round(-(FtCoRRtf0[2]+Zc),1)]

    mlist6 = [round(-(FtCoLF0[0]+Xp),1), round(FtCoLF0[1],1), round(FtCoLF0[2]-Zc,1), \
    round(-(FtCoLRtf2[0]-Xp),1), round(FtCoLR0[1],1), round(FtCoLRtf2[2]-Zc,1), \
    round(-(FtCoRFtf2[0]+Xp),1), round(FtCoRF0[1],1), round(-(FtCoRFtf2[2]+Zc),1), \
    round(-(FtCoRR0[0]-Xp),1), round(FtCoRR0[1],1), round(-(FtCoRR0[2]+Zc),1)]

    mlist1_h = [round(-(FtCoLFtf0[0]+Xp),1), round(FtCoLFtf0[1],1), round(FtCoLFtf0[2]-Zc,1), \
    round(-(FtCoLRtf0[0]-Xp),1), round(FtCoLRtf0[1],1), round(FtCoLRtf0[2]-Zc,1), \
    round(-(FtCoRFtf0[0]+Xp),1), round(FtCoRFtf0[1],1), round(-(FtCoRFtf0[2]+Zc),1), \
    round(-(FtCoRRtf0[0]-Xp),1), round(FtCoRRtf0[1],1), round(-(FtCoRRtf0[2]+Zc),1)]
...
print("y :Head control u :Left Turn/Left Head i: Fwd/Head Up    o: Right Turn/Right Head p:Body Up")
print("h :Walk control j :Left Side           k: Back/Head Down l: Right Side            +:Body Down")
