...
[-0.235,0.137,0.542,0.258,0.358,0.180,-0.258,-0.113,0.180,0.235,-0.248,0.542],
[-0.235,0.137,0.542,0.000,0.564,-0.115,0.000,-0.030,-0.115,0.235,-0.248,0.542],
[-0.235,0.137,0.542,0.000,0.082,0.264,0.000,0.082,0.264,0.235,-0.248,0.542],
[0.000,0.564,-0.115,0.000,0.082,0.264,0.000,0.082,0.264,0.000,-0.030,-0.115],
...
def talker():
    ...
    msg_lf.points = [JointTrajectoryPoint() for i in range(26)]
    msg_lr.points = [JointTrajectoryPoint() for i in range(26)]
    msg_rf.points = [JointTrajectoryPoint() for i in range(26)]
    msg_rr.points = [JointTrajectoryPoint() for i in range(26)]
